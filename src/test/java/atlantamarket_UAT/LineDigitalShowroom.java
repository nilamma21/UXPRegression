...
public class LineDigitalShowroom extends base {
	...
	public void TS001_VerifyLineDigitalShowroomHeroComponentShownByExhibitorNamaeTest()throws InterruptedException, IOException {
		...
		atlgs.getATLGlobalSearchTextBox().sendKeys(prop.getProperty("HeroComponentExhName3"));
		Thread.sleep(8000);
		//Click on 1st Suggetions
		atldigish.getsuggetionList().click();
		Thread.sleep(5000);
		//Verify Digi showrrom page
		Assert.assertTrue(atldigish.getAtlLineDigiShowroomPageTitle().getText().equals(prop.getProperty("HeroComponentExhName3")));
		//Click on Shown By Exhibitor Name
		String heroompName=atldigish.getdigiShowroomExhNameUAT().getText();
		atldigish.getdigiShowroomExhNameUAT().click();
	...
	public void TS002_VerifyLineDigitalShowroomHeroComponentLocationLinksTest()throws InterruptedException, IOException {
		...
		System.out.println("Line Name: "+prop.getProperty("line3"));
		Thread.sleep(8000);
		//Click on 1st Suggetions
		atldigish.getsuggetionListUAT().click();
		Thread.sleep(5000);
		//Verify Digi showrrom page
		System.out.println(atldigish.getAtlLineDigiShowroomPageTitle().getText());
		Assert.assertTrue(atldigish.getAtlLineDigiShowroomPageTitle().getText().equals(prop.getProperty("line3")));
	...
	public void TS003_VerifyLineDigitalShowroomHeroComponentProductsComponentCountTest()throws InterruptedException, IOException {
		...
		try {
		    ...
		    String heroCompName1 = atldigish.getdigiShowroomExhName1().getText();
            System.out.println(heroCompName1);
        }
    ...
    public void TS007_VerifyLineDigitalShowroomHeroComponentAddToFavoriteTest()throws InterruptedException, IOException {
        ...
        //Assert.assertTrue(atlmppge.getATLSavedExhNameInList().getText().contains(prop.getProperty("line3")));
        ...
        for (int i = 1; i < favlist.size(); i++) {
            ...
            Assert.assertFalse(favlist.get(i).getText().contains(prop.getProperty("line3")));
        }
    ...
    public void TS008_VerifyLineDigitalShowroomHeroComponentAddTolistTest()throws InterruptedException, IOException {
        ...
        utl.checkItemPresentInListorNot(atlmppge.getlistOfAllExh(), prop.getProperty("line3"));
         */
