...
public class FloorPlans extends base {
	...
	public void TS005_VerifyFunctionalityOfFiltersOFloorPlansPageTest() throws InterruptedException, IOException {
		...
		Thread.sleep(10000);
		List<WebElement> currentJuniperMarketList = driver
				.findElements(By.xpath("//a[@class='imc-type--title-5-link']"));
	...
	@Test(priority = 9)
	public void TS009_VerifySearchFunctionalityForExhListOnFloorPlansPageTest()
		...
		Thread.sleep(5000);
		Assert.assertTrue(
				atlflpp.getverifyexhibitor().getText().contains(prop.getProperty("floorplanexhibitorseacrch")));
	...
	public void TS010_VerifyAddToListFunctionalityForExhibitorOnFloorPlansPageTest() throws InterruptedException, IOException {
		...
		// 1st Exhibitor Name
		System.out.println("Exhibitor Name : " + atlflpp.getATLExhibitorName());
