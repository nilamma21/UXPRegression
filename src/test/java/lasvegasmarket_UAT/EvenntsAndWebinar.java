...
/*   //Event Month and Year
      ...
      String trimDate=eventDateAndMonth.split(" ")[2].trim();
      System.out.println("Trim Date: "+trimDate);
      Thread.sleep(2000);
      String date=trimDate.replaceAll("[,]", "");
      System.out.println("Date: "+date);
      String trimOnlyDate=date.split(" ")[0].trim();
      System.out.println("Trim Only Date: "+trimOnlyDate);
      String replaceDate=trimOnlyDate.replaceFirst("^0+(?!$)", "");
      System.out.println("Replace Date: "+replaceDate);
      String trimMonth = eventDateAndMonth.split(" ")[1].trim();
      System.out.println("Trim Month: "+trimMonth);
      String trimYear = eventDateAndMonth.split(" ")[3].trim();
    ...
    //Event Month and Year
      ...
      String trimDate=eventDateAndMonth.split(" ")[7].trim();
      System.out.println("Trim Date: "+trimDate);
      ...
      String trimMonth = eventDateAndMonth.split(" ")[6].trim();
      System.out.println("Trim Month: "+trimMonth);
      
      String trimYear = eventDateAndMonth.split(" ")[8].trim();
      System.out.println("Trim year: "+trimYear);
