...
public class MarketPlanner extends base {
	...
	public void TS001_VerifyMarketPlannerInvalidLoginCredentialsTest() throws InterruptedException, IOException {
		...
		lvmmp = new LVMMarketPlannerPage(driver);
		
		driver.manage().timeouts().implicitlyWait(30, TimeUnit.SECONDS);

		// Click Welcome Text
		lvmmp.getwelcometext().click();
		// Click Sign out link
		lvmmp.getsignout().click();
		lap.getLogin().click();
	...
	public void TS003_VerifyMarketPlannerChannelSelectorTest() throws InterruptedException, IOException {
		...
		driver.get(prop.getProperty("lvmurl_uat") + "Market-Planner");
		Thread.sleep(5000);
		...
		utl.selectDropdown(prop.getProperty("channelNameATLM"), prop.getProperty("lvmurl_uat"));
		driver.get(prop.getProperty("lvmurl_uat") + "Market-Planner");
		Thread.sleep(5000);
	...
	public void TS005_VerifyMarketPlannerSignOutTest() throws InterruptedException, IOException {
		...
		Assert.assertTrue(driver.getCurrentUrl().equalsIgnoreCase(prop.getProperty("lvmurl_uat")));
	...
	public void TS011_VerifyMPDashboardRegistrationCardOverviewTest() throws InterruptedException, IOException {
		...
		Assert.assertTrue(rURL.contains(prop.getProperty("lvmurl_uat") + "Attend/Registration"));
	}
	...
	public void TS016_VerifyMPDashboardListsCardOverviewTest() throws InterruptedException, IOException {
		...
		Assert.assertTrue(driver.getCurrentUrl().contains(prop.getProperty("lvmurl_uat") + "Market-Planner/Lists"));
	...
	public void TS017_VerifyMPDashboardActivitiesCardOverviewTest() throws InterruptedException, IOException {
		...
		Assert.assertTrue(driver.getCurrentUrl().contains(prop.getProperty("lvmurl_uat") + "Attend/Hotels"));
		...
		Assert.assertTrue(
				driver.getCurrentUrl().contains(prop.getProperty("lvmurl_uat") + "Market-Planner/Saved-Searches"));
		driver.navigate().back();

		atlmppge.getmpmyinfo().click();
		Assert.assertTrue(driver.getCurrentUrl().contains(prop.getProperty("lvmurl_uat") + "Market-Planner/My-Info"));
		driver.navigate().back();
	}
	...
	public void TS032_VerifyMarketPlannerRegistrationsTabTest() throws InterruptedException, IOException {
		...
		Assert.assertTrue(driver.getCurrentUrl().contains(prop.getProperty("lvmurl_uat")+"Market-Planner/Registrations"));

		atlmppge.getmpRegisterNowBtn().click();
		Thread.sleep(3000);

		Assert.assertFalse(driver.getCurrentUrl().contains(prop.getProperty("lvmurl_uat")+"Market-Planner/Registrations"));
