...
public class LineDigitalShowroom extends base{
	...
	public void TS001_VerifyLineDigitalShowroomHeroComponentShownByExhibitorNamaeTest()throws InterruptedException, IOException {
		...
		Assert.assertTrue(lvmdigish.getLVMLineDigiShowroomPageTitle().getText().equals(prop.getProperty("exhibitor7")));
	...
	public void TS002_VerifyLineDigitalShowroomHeroComponentLocationLinksTest()throws InterruptedException, IOException {
		...
		Thread.sleep(5000);
		//Verify Digi showrrom page
		Assert.assertTrue(lvmdigish.getLVMLineDigiShowroomPageTitle().getText().equals(prop.getProperty("exhibitor7"))); //For Prod
	...
	public void TS003_VerifyLineDigitalShowroomHeroComponentAddToFavoriteTest()throws InterruptedException, IOException {
		...
		//Verify Digi showrrom page
		Assert.assertTrue(lvmdigish.getLVMLineDigiShowroomPageTitle().getText().equals(prop.getProperty("exhibitor7"))); //For Prod
		//Assert.assertTrue(lvmdigish.getLVMLineDigiShowroomPageTitleUAT().getText().equals(prop.getProperty("exhibitor7"))); //For UAT
...
/*		// Sign In to MP
		...
		utl.checkItemPresentInListorNot(lvmmpp.getlistOfAllExh(), prop.getProperty("exhibitor7"));
	}
	@Test(priority = 05)
