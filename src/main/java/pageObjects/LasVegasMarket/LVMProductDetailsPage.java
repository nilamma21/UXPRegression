...
public class LVMProductDetailsPage {
	public WebDriver driver;
	public WebDriverWait wait;

	By lvmvalidateproddetailspage = By.xpath("(//div[@class='imc-product-details--section'])[position()=1]"); // Locator to validate Product Details page
	...
	public LVMProductDetailsPage(WebDriver driver) {
		// TODO Auto-generated constructor stub
		this.driver = driver; 			
	} 
	
	public WebElement getLVMValidateProdDetailsPage() {
		wait = new WebDriverWait (driver,30);
		wait.until(ExpectedConditions.visibilityOfElementLocated(lvmvalidateproddetailspage));
		return driver.findElement(lvmvalidateproddetailspage);
	}
