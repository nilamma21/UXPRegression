...
public class LVMMarketPlannerPage {
	...
	By lvmmarketplannerhome = By.xpath("//div[@class='imc-section imc-market-planner-toolbar ']"); // Locator for market planner home page
	By lvmfaveditlistbtn = By.xpath("//li[contains(text(),'Favorites')]/span"); //Locator for Edit list btn of Favorites list
	...
	By addlistcreatebtn_LVMPROD = By.xpath("//div[@class = 'imc-vr--medium-alt']/input[1]"); //Locator for Create button on Add List modal
	...
	By signout = By.xpath("//div[@class='imc-header-user-icon--links-settings']/a[2]"); //Locator for Signout link
	...
	By lvmmpduplicatelistoptns = By.xpath("//ul[@class='imc-market-planner-list']/li/div[2]/span[1]/a"); //Locator for Duplicate List options on Lists page
	By lvmmpGrByExhCheckbox = By.xpath("//div[@class='imc-gallery imc-market-planner-list-display imc-vr--large']/div[2]/div[1]/div[1]/div[1]"); //Locator for Gr By CheckBox
	By lvmmpListView = By.xpath("//div[@class='imc-gallery imc-market-planner-list-display imc-vr--large']/div[2]/div[1]/div[2]/button[1]"); //Locator for List View
	By lvmmpGridView = By.xpath("//div[@class='imc-gallery imc-market-planner-list-display imc-vr--large']/div[2]/div[1]/div[2]/button[2]"); //Locator for Grid view
	By lvmmpVerifyGridView = By.xpath("//img[@class='imc-saved-exhibitors__img-grid']"); //Locator for Grid view
	By lvmmpVerifyListView = By.xpath("//div[@class='imc-gallery imc-saved-exhibitors__outer-row imc-market-planner-list--mobile-overlays-left']"); //Locator for Grid view
	By lvmmpVerifyLocationLink = By.xpath("//a[@class='imc-link imc-link--alt-darkred']"); //Locator for Location Link
	...
	By lvmmpSaveSearcheBtn = By.xpath("//button[@class='imc-button--muted-inverted imc-icon--bookmark imc-button--full-width']");////Locator for Saved Searches Btn
	...
	By LVMAttendTab = By.xpath("//div[@class='imc-section']/div[1]/div[3]/div[1]/a[1]"); //Locator for Attend Tab
	By LVMAttendTabEventBtn = By.xpath("//a[@href='#events']"); //Locator for Attend Tab
	By LVMAttendTabEventMenu = By.xpath("//a[@href='/Attend/Events']"); //Locator for Attend Tab
	By LVMIMCEvent = By.xpath("//div[@class='event-list imc-loading__anchor']/div[1]/p[1]"); //Locator for IMC event Tab
	By LVMExhibitorEvent = By.xpath("//div[@class='event-list imc-loading__anchor']/div[1]/p[2]"); //Locator for Exhibitor Event Tab
	By LVMUseSavedSearchDropDown = By.xpath("//select[@name = 'Saved Searches']"); //Locator for Use Saved Search drop down 
	By EditListLvmistTab = By.xpath("//ul[@class = 'imc-market-planner-list']/li[1]/div[2]/span[2]/a[1]"); //Locator for Edit list link
