...
public class ATLMarketPlannerPage {
	...
	By newCreatedListName = By.xpath("//div[@class='imc-gallery imc-gallery--30-80 imc-gallery--1-2--mobile-full-width']/div[1]/div[1]/div[1]/div[1]/h3[1]"); //Locator for newly Created List name
	...
	By mpCurrentListName = By.xpath("//div[@class='imc-gallery imc-gallery--30-80 imc-gallery--1-2--mobile-full-width']/div[1]/div[1]/div[1]/div[1]/h3[1]"); //Locator for Current list name
	By mpRenameLink = By.xpath("//div[@class='imc-gallery imc-gallery--30-80 imc-gallery--1-2--mobile-full-width']/div[1]/div[1]/div[1]/div[1]/a[1]"); //Locator for rename link
	By mpRenameInputField = By.xpath("//div[@class='imc-gallery imc-gallery--30-80 imc-gallery--1-2--mobile-full-width']/div[1]/div[1]/div[1]/div[1]/form[1]/div[2]/input[1]"); //Locator for rename Input field
	By mpRenameInputSaveBtn = By.xpath("//div[@class='imc-gallery imc-gallery--30-80 imc-gallery--1-2--mobile-full-width']/div[1]/div[1]/div[1]/div[1]/form[1]/input[1]"); //Locator for rename Input Save Btn
	By mpRenameListName = By.xpath("//div[@class='imc-gallery imc-gallery--30-80 imc-gallery--1-2--mobile-full-width']/div[1]/div[1]/div[1]/div[1]/h3[1]"); //Locator for rename List Name
